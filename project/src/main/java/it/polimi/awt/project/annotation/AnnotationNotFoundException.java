...
public class AnnotationNotFoundException extends RuntimeException {
	...
	private static final long serialVersionUID = 3161310008885814487L;

	AnnotationNotFoundException(int annotationId) {
		super("could not find annotation '" + annotationId + "'.");
	}
