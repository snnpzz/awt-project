...
public interface AnnotationRepository extends JpaRepository<Annotation, Integer> {
	...
	Optional<List<Annotation>> findByCampaignIdAndPeakId(int campaignId, String peakId);

	Optional<Annotation> findByCampaignIdAndPeakIdAndWorkerName(int campaignId, String peakId, String workerName);
